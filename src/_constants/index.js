export const embedIds = [
  {
    id: "Uw_QyeHo8f0?si=fu1NvwHwp40dTXoj",
    description:
      "Warren Buffett shares 3 core principles for stock market investing. They're all very simple yet so important! Buffett generously explains each one in detail, hope you guys enjoy it and learn a great lesson.",
      heading:"Warren Buffett shares 3 core principles for stock market investing"
  },
  {
    id: "HG-TH6fBOJ4?si=SvnJippkC0rOf6rl",
    description:
      "Rich Dad Poor Dad author Robert Kiyosaki explained a very interesting concept he calls the “Cash Flow Quadrant.” He says that there is a thin line between the rich and the poor - those on the left side of the quadrant work for money because they need security. While those on the right side of the quadrant work for freedom so they don't have to work hard their entire life! Here are 8 assets that make people rich and never work again.",
      heading:"Rich Dad Poor Dad author Robert Kiyosaki explained..."
 
    },
  {
    id: "WKC2k1nS9HI?si=dbrywE4Pgi_HGYCj",
    description:
    ...
    heading:"Do you want to learn how to turn your money into more money?"
    },
];
